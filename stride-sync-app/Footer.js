...
const Footer = ({ navigation }) => (
  <View style={styles.bottomBar}>
    <TouchableOpacity style={styles.bottomBarItem} onPress={() => navigation.navigate('Dashboard')}>
      <Ionicons name="compass-outline" size={24} color='#D0FD3E'/>
      <Text style={styles.bottomBarText}>Home</Text>
    </TouchableOpacity>
    <TouchableOpacity style={styles.bottomBarItem} onPress={() => navigation.navigate('TrainingLog')}>
      <Ionicons name="barbell-outline" size={24} color='#FFFFFF'/>
      <Text style={styles.bottomBarText}>Exercise Library</Text>
    </TouchableOpacity>
    <TouchableOpacity style={styles.bottomBarItem} onPress={() => navigation.navigate('PerformancePrediction')}>
      <Ionicons name="stats-chart-outline" size={24} color='#FFFFFF'/>
      <Text style={styles.bottomBarText}>Performances</Text>
    </TouchableOpacity>
    <TouchableOpacity style={styles.bottomBarItem} onPress={() => navigation.navigate('CompetitionLog')}>
      <Ionicons name="calendar-outline" size={24} color='#FFFFFF'/>
      <Text style={styles.bottomBarText}>Competitions</Text>
    </TouchableOpacity>
    <TouchableOpacity style={styles.bottomBarItem} onPress={() => navigation.navigate('AdvancedDataVisualization')}>
